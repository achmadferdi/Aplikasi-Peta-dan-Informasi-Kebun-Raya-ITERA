...
class ConfigGlobal {
  static const namaAplikasi = "Peta Kebun Raya ITERA";
  static const lupaPassword = false;
  static const login = true;
  static const register = true;
  // static const baseUrl =
  //     "http://192.168.100.174/2023-ferdi-pemetaan-kebun-raya-itera";

  static const baseUrl =
      "https://localhost.scode.web.id/2023-ferdi-pemetaan-kebun-raya-itera";
