...
<a href="<?php index(); ?>">
    ...
    <div class="alert alert-warning">
        ...
        <hr class="message-inner-separator">
            <p>Silahkan Update Data Pengguna  dibawah ini.</p>
        </div>
    </div>
        ...
        <div class="content-box-content">
            <div id="postcustom">	
                <table <?php tabel_in(100, '%', 0, 'center'); ?>>	
                    ...
                    $sql = mysql_query("SELECT * FROM data_pengguna where id_pengguna = '$proses'");
                    $data = mysql_fetch_array($sql);
                    ?>
                    <!--h
                    <tr>
                        <td width="25%" class="leftrowcms">					
                            <label >Id Pengguna  <font color="red">*</font></label>
                        </td>
                        <td width="2%">:</td>
                        <td>
                    ...
                    h-->
                    <input type="hidden" class="form-control" name="id_pengguna" value="<?php echo $data['id_pengguna']; ?>" readonly  id="id_pengguna" required="required">
                          ...
                          <tr>
                            ...
                            <td>
                                ...
                                <option value="<?php echo ($data['jenis_kelamin']); ?>">- <?php echo ($data['jenis_kelamin']); ?> -</option><?php combo_enum('data_pengguna','jenis_kelamin',''); ?>
                                </select>
                            </td>
                        </tr>
                          <tr>
