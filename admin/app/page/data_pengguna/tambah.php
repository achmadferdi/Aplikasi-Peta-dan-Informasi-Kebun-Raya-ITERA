...
<a href="<?php index(); ?>">
    ...
    <div class="alert alert-success">
        ...
        <hr class="message-inner-separator">
            <p>Silahkan input Data Pengguna  dibawah ini.</p>
        </div>
    </div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td width="25%" class="leftrowcms">					
                                <label >Id Pengguna  <span class="highlight">*</span></label>
                            </td>
                            <td width="2%">:</td>
                            <td>
                              <?php echo id_otomatis("data_pengguna", "id_pengguna", "10"); ?>  		
                            </td>
                        </tr>
                        h-->
                        <input type="hidden" class="form-control" readonly value="<?php echo id_otomatis("data_pengguna", "id_pengguna", "10"); ?>" name="id_pengguna" placeholder="Id Pengguna " id="id_pengguna" required="required">
                          ...
                          <tr>
                            ...
                            <td>
                                ...
                                <option></option><?php combo_enum('data_pengguna','jenis_kelamin',''); ?>
                                </select>
                            </td>
                        </tr>
                          <tr>
